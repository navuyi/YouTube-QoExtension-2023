...
var options = {
  ...
  entry: {
    ...
    finished: path.join(__dirname, 'src', 'pages', 'Finished', 'index.tsx'),
    ...
    */
    ...
    /*
    netflixControls: path.join(
      __dirname,
      'src',
      'scripts',
      'netflix-controls-script.js'
    ),
    cadmiumPlayercore: path.join(
      __dirname,
      'src',
      'scripts',
  ...
  plugins: [
    ...
    */
    ...
    new HtmlWebpackPlugin({
      template: path.join(__dirname, 'src', 'pages', 'Finished', 'index.html'),
